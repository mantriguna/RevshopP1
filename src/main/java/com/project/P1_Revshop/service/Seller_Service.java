...
//    private PasswordEncoder passwordEncoder;
    ...
    public Seller getSellerbySellerIdSeller(Long sellerId) {
    ...
    @Transactional
    public void updateSellerDetails(SellerDTO sellerDTO, String currentPassword) throws Exception {
    ...
    @Transactional
    public void updateSellerPassword(Long sellerid,String currentPassword,String newPassword) throws Exception{
    ...
    public Seller getSellerByIdF(Long sellerId) {
        Seller seller = seller_ep.findById(sellerId).orElseThrow(() -> new RuntimeException("Seller not found"));
        return seller;
    }
    ...
    public void updateSellerPasswordforget(String em, String hashPassword) {
    ...
    public boolean emailExists(String email) {
        return seller_ep.findByEmail(email) != null;
    }
